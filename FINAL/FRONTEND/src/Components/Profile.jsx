...
const MyProfile = () => {
  ...
  // Mocking already registered name and email
  ...
  useEffect(() => {
    // Set already registered username and email
    setUsername(registeredUserData.username);
    setEmail(registeredUserData.email);
  }, []);
