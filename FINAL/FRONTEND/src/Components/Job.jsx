    ...
    <div className="appjob-container">
      ...
      <div className="content">
       ...
       <div className="writing"><p>You can search and apply for a job with your own decision.</p>
        ...
        <h2 className="recent"><center>Recent Jobs</center></h2>
...
<Link to="/Form" className="job-link">
  ...
  <div className="custom-job-listing-container">
    ...
    <h2 className="open"><center>Job Opening in Top Companies</center></h2></Link>
<Slides/>
      <ul className="navbar">
        ...
        <Link to ="/Premium"><li className="nav-right"><a className="nav-link blink" href="#premium">Premium Jobs</a></li></Link>
        <Link to ="/Viewjobs"><li className="nav-right"><a className="nav-link blink" href="#premium">View Applied Jobs</a></li></Link>
        <Link to="/Updateuser"><li><a className="nav-link" href="#home">Update Form</a></li></Link>
        <Link to="/Deleteuserform"><li><a className="nav-link" href="#home">Delete Form</a></li></Link>
      </ul>
      ...
      <nav>
        <ul className="footer-list">
          ...
          <li><a className="footer-link" href={FAQS}>FAQs</a></li>
          ...
          <li className="bck">
  <Link to="/Feedback" className="bck">Feedback</Link>
</li>
